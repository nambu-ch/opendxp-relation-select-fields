 ...
 * http://www.opendxp.io/license
 *
 * @copyright  Copyright (c) 2017 nambu GmbH (http://www.nambu.ch)
 */

opendxp.registerNS("opendxp.object.classes.data.manyToManyRelationSelect");
opendxp.object.classes.data.manyToManyRelationSelect = Class.create(opendxp.object.classes.data.manyToManyRelation, {
    ...
    getLayout: function ($super) {
        ...
        this.specificPanel.items.items[2].items.items[2].add([
            {
                fieldLabel: t("relationselectfieldsbundle_relationselect_folder"),
                name: "assetFolder",
                fieldCls: "input_drop_target",
