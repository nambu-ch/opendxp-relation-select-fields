...
opendxp.registerNS("opendxp.object.tags.manyToManyRelationSelect");
opendxp.object.tags.manyToManyRelationSelect = Class.create(opendxp.object.tags.manyToManyRelation, {
        ...
        this.store = new Ext.data.JsonStore({
            ...
            listeners: {
                load: function(store, records, success, operation) {
                    if (!success) {
                        opendxp.helpers.showNotification(t("error"), t("error_loading_options"), "error", operation.getError());
                    }
